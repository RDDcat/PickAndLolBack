...
public class OAuthService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    @Autowired
    public OAuthService(MemberRepository memberRepository, OAuth2AuthorizedClientService authorizedClientService) {
    ...
    public Member getCurrentMember(Authentication authentication) {
        ...
        return memberRepository.findByOauthId(oauthId)
                .orElseThrow(() -> new UsernameNotFoundException("User not found: " + oauthId));
    }
}